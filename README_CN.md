...
### Windows 本地IDE源码编译启动
1. 编译前端：ps: .\assembly\bin\supersonic-build.bat webapp
2. 启动后端：IDE本地启动Java类 com.tencent.supersonic.StandaloneLauncher （位于 launchers/standalone/src/main/java目录下）
